 ...
 * 
 * This is used to calculate the CRC16 for the Anviz TC_B protocol. This is 
 * basically a slightly modified version of an answer from SO to work in JS.
 * 
 * @see http://stackoverflow.com/questions/18929423/whats-the-checksum-algorithm-for-anviz-devices/24754362#24754362
 */
...
/**
 * The CRC16 check to use with Anviz devices.
 * 
 * @param  {[type]} input [description]
 * @return {[type]}       [description]
 */
module.exports = function crc16 (input) {
	var
		i = 0,
		l = 0,
		crc = 0xFFFF
